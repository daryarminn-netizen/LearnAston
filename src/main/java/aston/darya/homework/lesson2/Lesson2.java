...
public class Lesson2 {
    ...
    public static void main(String[] args) {
        ...
        printStringMultipleTimes("Emmi Farra Fauler", 6);
        System.out.println(checkIfYearIsLeap(1986));
        int[] array = {1, 1, 0, 0, 1, 0, 1, 1, 0, 0};
        convertArray(array);
        fillArray();
        convertArray();
        fillMatrix();
        fillByInitialValue(5, 78);
     ...
     */
    public static int[] fillByInitialValue(int len, int initialValue) {
